...
exports.serverError = function (callback) {
    return function (err, req, res, next) {
        callback('event:serverError', req, res, err);
    };
};

exports.fileNotFound = function (template, callback) {
    return function (req, res, next) {
        ...
        callback(req.url, new Error('file not found'));
    };
};


exports.serverError = function (template, callback) {
    return function (err, req, res, next) {

...
var proto = {
    ...
    _views: function () {
        ...
        // localization provides it's own cache, so disable other caches only
        // if it's explicitly set to true.
        i18n = config.get('i18n');
        cache = i18n && i18n.cache === true;
        ...
        Object.keys(engines).forEach(function (ext) {
            ...
            if (typeof renderer === 'function' && renderer.length === 1) {
                ...
                meta.settings.cache = cache ? false : meta.settings.cache;

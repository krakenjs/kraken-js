...
var proto = {
    ...
    _middleware: function () {
        var app, delegate, config, srcRoot, staticRoot;
        ...
        app.use(function (req, res, next) {
            var page404 = config.errorPages && config.errorPages['404'],
                model = { url: req.url };
        ...
        app.use(function (err, req, res, next) {
            var page500 = config.errorPages && config.errorPages['500'],
                model = { url: req.url, err: err };

            res.status(500);

            if (typeof delegate.requestError === 'function') {
                delegate.requestError(err, app);
            }

...
var proto = {
    ...
    _views: function () {
        ...
        if (i18n) {
            ...
            this._templateProcessor =  module && module.create(app, i18n);
        } else {
            //TODO implement an onload in karka which will do the specialization
        }
    ...
    _middleware: function () {
        var app, delegate, config, srcRoot, staticRoot, errorPages, specialization;
        ...
        specialization = this._config.get('specialization');
        ...
        if (specialization) {
            var module = util.tryRequire('karka'),
                specializer = module && module.create(specialization);
            if(specializer) {
                app.use(specializer.templateMapper);
            }
        }
